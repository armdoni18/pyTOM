...
In this implementation the coefficients are written as a=49.4, b=1.46, c=520.6 for the ferromagnetic material used in the numerical examples.

Convention note
---------------
Although Eq. (3) is written in terms of the reluctivity nu, this function returns the **permeability** mu = 1/nu to follow the Brauer's model. The conversion to reluctivity (and to its derivative through the chain rule dnu/dB = -(dmu/dB)/mu^2)
