...
2. The initial design variables. TThe design variables are
   initialized within the physical density range [0,1].
   The Heaviside projection of Eq. (19), The Heaviside projection
   of Eq. (19) is subsequently applied to progressively sharpen
   the material distribution as the projection parameter beta
   increases, while the optimization formulation of Eqs. (10)-(14)
   remains unchanged.
