"""
F4_Main_Solve_VecPot.py — Numerical Example 2 (linear actuator)
==================================================================

Magnetostatic linear solver for the linear-material actuator of Section 5.2.
...
In the linear example, this solve is the final solve (no NR iteration is performed).
"""
