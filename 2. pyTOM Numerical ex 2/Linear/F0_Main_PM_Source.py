...
lumped in equal halves to the two endpoint nodes. The orientation of the outward normal is determined from the signed area of the triangle, so the convention is consistent for arbitrary mesh node orderings.
